...
export default function IndexPage() {
  ...
  const getTime = (time) => {
    const currentVideoProgress = Math.trunc(
      (time.returnValue / videoDuration) * 100
    );
  ...
  return (
    <div>
      <Head>
        <script src="https://bigluckypal.cdn.spotlightr.com/assets/spotlightr.js" />
      </Head>
      <h2>New player</h2>
      <iframe
        ...
        src={`https://bigluckypal.cdn.spotlightr.com/watch/${videoID}`} // New player uses "/watch" instead of "/publish"
        watch-type=""
        url-params=""
        frameBorder="0"
        scrolling="no"
